package com.tibco.ep.samples.highavailability.two_node_active_standby;
...
public class TestCase extends UnitTest {
    ...
    public static void setupServer() throws StreamBaseException, ConfigurationException, InterruptedException {
        ...
        server.startServer();
        server.loadApp("com.tibco.ep.samples.highavailability.two_node_active_standby.TwoNodeActiveStandbyEventFlowFragment");
    }
